...
const navItems = [
  ...
  { id: "explore", icon: "search", label: "Buscar", path: "/explore" },
  { id: "create", icon: "add_box", label: "Criar", path: null },
  { id: "messages", icon: "chat", label: "Mensagens", path: "/messages" },
  { id: "notifications", icon: "notifications", label: "Notificações", path: null },
  { id: "profile", icon: "person", label: "Perfil", path: "/profile" },
  { id: "settings", icon: "settings", label: "Configurações", path: "/settings/edit" },
];
  ...
  return (
    <>
      <aside className="sticky top-14 h-[calc(100vh-3.5rem)] w-64 flex-shrink-0 overflow-y-auto border-r border-border bg-card p-4">
        {/* User Profile Card */}
        <div className="mb-6 rounded-xl bg-background p-4 shadow-sm border border-border">
