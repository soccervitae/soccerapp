          ...
          <div className="flex items-end gap-5 -mt-14">
            ...
            <div className="flex items-center gap-4 flex-shrink-0 pt-16">
              ...
              <div className="flex items-center gap-2">
                {isOwnProfile ? (
                  <>
                    <button onClick={() => navigate("/settings/profile")} className="bg-muted hover:bg-muted/80 text-foreground h-10 px-5 rounded-sm font-semibold text-sm transition-colors border border-border flex items-center gap-2">
                      <span className="material-symbols-outlined text-[18px]">edit</span>
                      Editar
                    </button>
                    {useSheet ? (
                      <>
                        <button onClick={() => setShareSheetOpen(true)} className="bg-muted hover:bg-muted/80 text-foreground h-10 w-10 rounded-lg text-sm transition-colors border border-border flex items-center justify-center">
