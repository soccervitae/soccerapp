          ...
          <div className="flex items-end gap-5 -mt-14">
            ...
            <div className="flex items-center gap-4 flex-shrink-0 pt-16">
              ...
              <div className="flex items-center gap-2">
                {isOwnProfile ? (
                  <>
                    <button onClick={() => navigate("/settings/profile")} className="bg-primary text-primary-foreground h-10 px-5 rounded-full font-semibold text-sm transition-colors hover:bg-primary/90 flex items-center gap-2">
          ...
          <div className="flex gap-3 mt-5 ml-[8.5rem]">
            {isOwnProfile ? (
              ...
              <>
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="bg-primary text-primary-foreground h-10 px-6 rounded-full font-semibold text-sm transition-colors hover:bg-primary/90 flex items-center gap-2">
                      <span className="material-symbols-outlined text-[18px]">share</span>
                      Compartilhar
                    </button>
                  </DropdownMenuTrigger>
