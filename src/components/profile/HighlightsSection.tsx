...
export const HighlightsSection = () => {
  return <section>
      ...
      <div className="flex gap-3 overflow-x-auto no-scrollbar -mx-4 px-4">
        {highlights.map(highlight => <div key={highlight.label} className="flex-none w-20 flex flex-col gap-2 items-center">
            <div className="w-16 h-16 rounded-full p-[2px] bg-muted cursor-pointer hover:bg-primary transition-colors group">
              <div className="w-full h-full rounded-full bg-cover bg-center border-2 border-background" style={{
