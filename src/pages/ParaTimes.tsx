  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Cadastre seu time de futebol no SOCCER VITAE. Encontre jogadores, monte seu elenco e dê visibilidade ao seu clube. Amador ou profissional." />
