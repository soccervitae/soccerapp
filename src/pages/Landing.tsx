      ...
      <div className="min-h-screen bg-[#102216] text-white font-sans">
        ...
        <section className="w-full">
          <div className="p-0 md:p-4">
            <div className="relative flex min-h-[320px] flex-col gap-6 md:gap-8 md:rounded-xl items-center justify-center p-4 overflow-hidden bg-cover bg-center bg-no-repeat" style={{
