...
export default function Verification() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border px-4 h-14 flex items-center" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
        <button
