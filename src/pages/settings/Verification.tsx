...
export default function Verification() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border px-4 h-14 flex items-center" style={{ paddingTop: 'max(22px, env(safe-area-inset-top))' }}>
        <button
      ...
      <div className="pt-14 pb-20 px-4">
        ...
        <div className="bg-card rounded-xl border border-border p-6 mb-6 text-center">
          ...
          <p className="text-4xl font-black text-foreground">R$ 199,90</p>
          <p className="text-sm text-muted-foreground mt-1">/ano</p>
          <p className="text-sm text-primary font-semibold mt-2">ou 12x de R$ 19,90</p>
        </div>
