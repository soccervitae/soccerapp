  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData: Record<string, unknown> = {
        ...
        nickname: isTeamOrSchoolAccount ? teamName.trim().toUpperCase() : (nickname.trim() || null),
        full_name: isTeamOrSchoolAccount ? teamName.trim().toUpperCase() : undefined,
